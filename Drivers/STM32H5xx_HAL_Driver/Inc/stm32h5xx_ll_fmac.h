 ...
 * @retval None
 */
__STATIC_INLINE void LL_FMAC_ConfigX1(FMAC_TypeDef *FMACx, uint32_t Watermark, uint8_t Base,
                                      uint8_t BufferSize)
{
 ...
 * @retval None
 */
__STATIC_INLINE void LL_FMAC_ConfigY(FMAC_TypeDef *FMACx, uint32_t Watermark, uint8_t Base,
                                     uint8_t BufferSize)
{
 ...
 * @retval None
 */
__STATIC_INLINE void LL_FMAC_ConfigFunc(FMAC_TypeDef *FMACx, uint8_t Start, uint32_t Function,
                                        uint8_t ParamP, uint8_t ParamQ, uint8_t ParamR)
{
  MODIFY_REG(
      FMACx->PARAM, FMAC_PARAM_START | FMAC_PARAM_FUNC | FMAC_PARAM_P | FMAC_PARAM_Q | FMAC_PARAM_R,
      (((uint32_t) Start) << FMAC_PARAM_START_Pos) | Function |
          (((uint32_t) ParamP) << FMAC_PARAM_P_Pos) | (((uint32_t) ParamQ) << FMAC_PARAM_Q_Pos) |
