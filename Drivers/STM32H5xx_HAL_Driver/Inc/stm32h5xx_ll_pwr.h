...
#define LL_PWR_REGU_VOLTAGE_SVOS_SCALE3                                                            \
  (PWR_PMCR_SVOS_0 | PWR_PMCR_SVOS_1) /*!< Select voltage scale 3 when system enters STOP mode */
/**
 * @}
 */
...
{
  return (
      (READ_BIT(PWR->WUCR, (WakeUpPin << PWR_WUCR_WUPP1_Pos)) == (WakeUpPin << PWR_WUCR_WUPP1_Pos))
          ? 1UL
          : 0UL);
}
