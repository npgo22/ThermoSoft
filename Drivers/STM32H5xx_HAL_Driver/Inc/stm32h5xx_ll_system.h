...
#define LL_SBS_VDDIO_REGISTER_CODE                                                                 \
  SBS_CCCSR_CS2 /*!< VDDIO I/Os code from the SBS compensation cell code register (SBS_CCSWCR)*/
/**
 * @}
 */
...
#define LL_SBS_MEMORIES_ERASE_MCLR_ON_GOING                                                        \
  0x0UL /*!< Erase after Power-on Reset of SRAM2, BKPRAM, ICACHE, DCACHE and PKA RAMs on going or  \
           cleared by SW */
#define LL_SBS_MEMORIES_ERASE_MCLR_ENDED                                                           \
  SBS_MESR_MCLR /*!< Erase after Power-on Reset of SRAM2, BKPRAM, ICACHE, DCACHE and PKA RAMs done \
                 */
#define LL_SBS_MEMORIES_ERASE_IPMEE_ON_GOING                                                       \
  0x0UL /*!< Erase after Power-on Reset or Tamper detection for ICACHE and PKA RAMs on going or    \
           cleared by SW */
#define LL_SBS_MEMORIES_ERASE_IPMEE_ENDED                                                          \
  SBS_MESR_IPMEE /*!< Erase after Power-on Reset or Tamper detection for ICACHE and PKA RAMs done  \
                  */
/**
 * @}
 */
...
#define LL_SBS_OBKHDPL_INCR_0                                                                      \
  0x00000000U /*!< Index to add to the current HDPL to point (through OBK-HDPL) to the next secure \
                 storage areas */
#define LL_SBS_OBKHDPL_INCR_1                                                                      \
  SBS_NEXTHDPLCR_NEXTHDPL_0 /*!< Index to add to the current HDPL to point (through OBK-HDPL) to   \
                               the next secure storage areas */
#define LL_SBS_OBKHDPL_INCR_2                                                                      \
  SBS_NEXTHDPLCR_NEXTHDPL_1 /*!< Index to add to the current HDPL to point (through OBK-HDPL) to   \
                               the next secure storage areas */
#define LL_SBS_OBKHDPL_INCR_3                                                                      \
  SBS_NEXTHDPLCR_NEXTHDPL /*!< Index to add to the current HDPL to point (through OBK-HDPL) to the \
                             next secure storage areas */
/**
 * @}
 */
...
#define LL_SBS_LOCK_ALL_NSEC                                                                       \
  (LL_SBS_MPU_NSEC |                                                                               \
   LL_SBS_VTOR_NSEC) /*!< lock all Non-secure  (privileged secure or non-secure only) */
/**
 * @}
 */
...
#define LL_DBGMCU_APB1_GRP1_WWDG_STOP                                                              \
  DBGMCU_APB1FZR1_DBG_WWDG_STOP /*!< The window watchdog counter clock is stopped when the core is \
                                   halted*/
...
#define LL_DBGMCU_APB3_GRP1_I2C4_STOP                                                              \
  DBGMCU_APB3FZR_DBG_I2C4_STOP /*!< The counter clock of I2C4 is stopped when the core is halted*/
#endif                         /* I2C4 */
#if defined(I3C2)
#define LL_DBGMCU_APB3_GRP1_I3C2_STOP                                                              \
  DBGMCU_APB3FZR_DBG_I3C2_STOP /*!< The counter clock of I3C2 is stopped when the core is halted*/
#endif                         /* I3C2 */
#define LL_DBGMCU_APB3_GRP1_LPTIM1_STOP                                                            \
  DBGMCU_APB3FZR_DBG_LPTIM1_STOP /*!< The counter clock of LPTIM1 is stopped when the core is      \
                                    halted*/
#if defined(LPTIM3)
#define LL_DBGMCU_APB3_GRP1_LPTIM3_STOP                                                            \
  DBGMCU_APB3FZR_DBG_LPTIM3_STOP /*!< The counter clock of LPTIM3 is stopped when the core is      \
                                    halted*/
#endif                           /* LPTIM3 */
#if defined(LPTIM4)
#define LL_DBGMCU_APB3_GRP1_LPTIM4_STOP                                                            \
  DBGMCU_APB3FZR_DBG_LPTIM4_STOP /*!< The counter clock of LPTIM4 is stopped when the core is      \
                                    halted*/
#endif                           /* LPTIM4 */
#if defined(LPTIM5)
#define LL_DBGMCU_APB3_GRP1_LPTIM5_STOP                                                            \
  DBGMCU_APB3FZR_DBG_LPTIM5_STOP /*!< The counter clock of LPTIM5 is stopped when the core is      \
                                    halted*/
#endif                           /* LPTIM5 */
#if defined(LPTIM6)
#define LL_DBGMCU_APB3_GRP1_LPTIM6_STOP                                                            \
  DBGMCU_APB3FZR_DBG_LPTIM6_STOP /*!< The counter clock of LPTIM6 is stopped when the core is      \
                                    halted*/
#endif                           /* LPTIM6 */
...
{
  return (uint32_t) (READ_BIT(SBS->CFGR2,
...
{
  return ((READ_BIT(SBS->DBGLOCKR, SBS_DBGLOCKR_DBGCFG_LOCK) != LL_SBS_DBG_CONFIG_UNLOCK) ? 1UL
                                                                                          : 0UL);
}
