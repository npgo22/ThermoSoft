...
typedef struct {
  ...
  RCC_PLL2InitTypeDef PLL2; /*!< PLL2structure parameters.
                                 This parameter will be used only when PLL2 is selected as kernel
                               clock Source for some peripherals */
  ...
  uint32_t
      CkperClockSelection; /*!< Specifies CKPER clock source
...
#if defined(LPTIM3)
  uint32_t
      Lptim3ClockSelection; /*!< Specifies LPTIM3 clock source.
                                 This parameter can be a value of @ref RCCEx_LPTIM3_Clock_Source */
#endif                      /* LPTIM3 */

#if defined(LPTIM4)
  uint32_t
      Lptim4ClockSelection; /*!< Specifies LPTIM4 clock source.
                                 This parameter can be a value of @ref RCCEx_LPTIM4_Clock_Source */
#endif                      /* LPTIM4 */

#if defined(LPTIM5)
  uint32_t
      Lptim5ClockSelection; /*!< Specifies LPTIM5 clock source.
                                 This parameter can be a value of @ref RCCEx_LPTIM5_Clock_Source */
#endif                      /* LPTIM5 */

#if defined(LPTIM6)
  uint32_t
      Lptim6ClockSelection; /*!< Specifies LPTIM6 clock source.
                                 This parameter can be a value of @ref RCCEx_LPTIM6_Clock_Source */
#endif                      /* LPTIM6 */

  uint32_t
      FdcanClockSelection; /*!< Specifies FDCAN kernel clock source.
...
#if defined(SDMMC1)
  uint32_t
      Sdmmc1ClockSelection; /*!< Specifies SDMMC1 clock source.
                               This parameter can be a value of @ref RCCEx_SDMMC1_Clock_Source */
#endif                      /* SDMMC1 */

#if defined(SDMMC2)
  uint32_t
      Sdmmc2ClockSelection; /*!< Specifies SDMMC2 clock source.
  ...
  uint32_t DacLowPowerClockSelection; /*!< Specifies DAC low-power clock source used in Sample and
                                         hold mode. This parameter can be a value of @ref
...
typedef struct {
  ...
  uint32_t
      ErrorLimitValue; /*!< Specifies the value to be used to evaluate the captured frequency error
                          value. This parameter must be a number between 0 and 0xFF or a value of
...
typedef struct {
  ...
  uint32_t
      FreqErrorDirection; /*!< Specifies the value loaded in the .FEDIR, the counting direction of
...
#define __HAL_RCC_TIMIC_ENABLE()                                                                   \
  SET_BIT(RCC->CCIPR1, RCC_CCIPR1_TIMICSEL) /*!< HSI/1024, CSI/128 and HSI/8 generation for Timers \
 ...
 * @retval None
 */
#define __HAL_RCC_PLL2_CONFIG(__PLL2SOURCE__, __PLL2M__, __PLL2N__, __PLL2P__, __PLL2Q__,          \
                              __PLL2R__)                                                           \
  do {                                                                                             \
 ...
 * @retval None
 */
#define __HAL_RCC_PLL3_CONFIG(__PLL3SOURCE__, __PLL3M__, __PLL3N__, __PLL3P__, __PLL3Q__,          \
                              __PLL3R__)                                                           \
  do {                                                                                             \
...
#define RCC_PERIPHCLOCK_ALL                                                                        \
  (RCC_PERIPHCLK_USART1 | RCC_PERIPHCLK_USART2 | RCC_PERIPHCLK_USART3 | RCC_PERIPHCLK_UART4 |      \
   RCC_PERIPHCLK_UART5 | RCC_PERIPHCLK_USART6 | RCC_PERIPHCLK_UART7 | RCC_PERIPHCLK_UART8 |        \
   RCC_PERIPHCLK_UART9 | RCC_PERIPHCLK_USART10 | RCC_PERIPHCLK_USART11 | RCC_PERIPHCLK_UART12 |    \
   RCC_PERIPHCLK_LPUART1 | RCC_PERIPHCLK_I2C1 | RCC_PERIPHCLK_I2C2 | RCC_PERIPHCLK_I2C3 |          \
   RCC_PERIPHCLK_I2C4 | RCC_PERIPHCLK_I3C1 | RCC_PERIPHCLK_TIM | RCC_PERIPHCLK_LPTIM1 |            \
...
#define RCC_PERIPHCLOCK_ALL                                                                        \
  (RCC_PERIPHCLK_USART1 | RCC_PERIPHCLK_USART2 | RCC_PERIPHCLK_USART3 | RCC_PERIPHCLK_UART4 |      \
   ...
   RCC_PERIPHCLK_I2C2 | RCC_PERIPHCLK_I2C3 | RCC_PERIPHCLK_I3C1 | RCC_PERIPHCLK_I3C2 |             \
   RCC_PERIPHCLK_TIM | RCC_PERIPHCLK_LPTIM1 | RCC_PERIPHCLK_LPTIM2 | RCC_PERIPHCLK_ADCDAC |        \
   RCC_PERIPHCLK_DAC_LP | RCC_PERIPHCLK_RNG | RCC_PERIPHCLK_RTC | RCC_PERIPHCLK_SDMMC1 |           \
   RCC_PERIPHCLK_SPI1 | RCC_PERIPHCLK_SPI2 | RCC_PERIPHCLK_SPI3 | RCC_PERIPHCLK_SPI4 |             \
   RCC_PERIPHCLK_OSPI | RCC_PERIPHCLK_FDCAN | RCC_PERIPHCLK_CEC | RCC_PERIPHCLK_USB |              \
   RCC_PERIPHCLK_CKPER)
#else
#define RCC_PERIPHCLOCK_ALL                                                                        \
  (RCC_PERIPHCLK_USART1 | RCC_PERIPHCLK_USART2 | RCC_PERIPHCLK_USART3 | RCC_PERIPHCLK_LPUART1 |    \
   RCC_PERIPHCLK_I2C1 | RCC_PERIPHCLK_I2C2 | RCC_PERIPHCLK_I3C1 | RCC_PERIPHCLK_I3C2 |             \
   RCC_PERIPHCLK_TIM | RCC_PERIPHCLK_LPTIM1 | RCC_PERIPHCLK_LPTIM2 | RCC_PERIPHCLK_ADCDAC |        \
   RCC_PERIPHCLK_DAC_LP | RCC_PERIPHCLK_RNG | RCC_PERIPHCLK_RTC | RCC_PERIPHCLK_SPI1 |             \
   RCC_PERIPHCLK_SPI2 | RCC_PERIPHCLK_SPI3 | RCC_PERIPHCLK_FDCAN | RCC_PERIPHCLK_USB |             \
   RCC_PERIPHCLK_CKPER)
#endif /*FDCAN2 && SDMMC2 */
/**
 * @}
