...
typedef struct {
  ...
  uint32_t
      HSICalibrationValue; /*!< The calibration trimming value (default is
                              ...
                              Min_Data = 0x00 and Max_Data = 0x7F on the other devices */
  ...
  uint32_t CSICalibrationValue; /*!< The calibration trimming value (default is
                                   RCC_CSICALIBRATION_DEFAULT). This parameter must be a number
                                   between Min_Data = 0x00 and Max_Data = 0x3F */
...
typedef struct {
  ...
  uint32_t APB3CLKDivider; /*!< The APB3 clock (PCLK3) divider. This clock is derived from the AHB
                              clock (HCLK). This parameter can be a value of @ref
                              RCC_APB1_APB2_APB3_Clock_Source      */
} RCC_ClkInitTypeDef;
...
#define RCC_HSE_BYPASS                                                                             \
  ((uint32_t) (RCC_CR_HSEBYP | RCC_CR_HSEON)) /*!< External Analog clock source for HSE clock */
...
#define RCC_LSE_BYPASS                                                                             \
  ((uint32_t) (RCC_BDCR_LSEBYP |                                                                   \
               RCC_BDCR_LSEON)) /*!< External Analog clock source for LSE clock Bypassed*/
#define RCC_LSE_BYPASS_DIGITAL                                                                     \
  ((uint32_t) (RCC_BDCR_LSEEXT | RCC_BDCR_LSEBYP |                                                 \
               RCC_BDCR_LSEON)) /*!< External Digital clock source for LSE clock Bypassed */
/**
 * @}
 */
...
#define RCC_FLAG_SFTRST                                                                            \
  ((uint32_t) ((RCC_RSR_REG_INDEX << 5U) | RCC_RSR_SFTRSTF_Pos)) /*!< Software Reset flag */
...
#define RCC_FLAG_LPWRRST                                                                           \
  ((uint32_t) ((RCC_RSR_REG_INDEX << 5U) | RCC_RSR_LPWRRSTF_Pos)) /*!< Low-Power reset flag */
...
/**
  ...
  * @retval None
  */
#define __HAL_RCC_PLL1_CONFIG(__PLL1SOURCE__, __PLL1M__, __PLL1N__, __PLL1P__, __PLL1Q__,          \
                              __PLL1R__)                                                           \
  do {                                                                                             \
...
#define IS_RCC_SINGLE_ITEM_ATTRIBUTES(ITEM)                                                        \
  (((ITEM) == RCC_HSI) || ((ITEM) == RCC_HSE) || ((ITEM) == RCC_CSI) || ((ITEM) == RCC_LSI) ||     \
   ((ITEM) == RCC_LSE) || ((ITEM) == RCC_SYSCLK) || ((ITEM) == RCC_PRESC) ||                       \
   ((ITEM) == RCC_PLL1) || ((ITEM) == RCC_PLL2) || ((ITEM) == RCC_PLL3) ||                         \
   ((ITEM) == RCC_HSI48) || ((ITEM) == RCC_RMVF) || ((ITEM) == RCC_CKPERSEL))
#endif /* RCC_SECCFGR_HSISEC */
