...
typedef struct {
  ...
  uint32_t NbSectors; /*!< Number of sectors to be erased.
                           This parameter can be a value between 1 and (max number of sectors in the
                         bank - value of initial sector)*/
...
typedef struct {
  ...
  uint32_t HDPStartSector; /*!< Start sector of HDP area (used for OPTIONBYTE_HDP).
                                This parameter must be a value between 0 and (max number of sectors
                              in the bank - 1) */

  uint32_t HDPEndSector; /*!< End sector of HDP area (used for OPTIONBYTE_HDP).
                              This parameter must be a value between 0 and (max number of sectors in
                            the bank - 1) */
...
typedef struct {
  ...
  uint32_t BBAttributesType; /*!< Block-Based Attributes type.
                                  ...
                                  */
  uint32_t
      BBAttributes_array[FLASH_BLOCKBASED_NB_REG]; /*!< Each bit specifies the block-based attribute
                                                      configuration of a sector: 0 means sector
                                                      non-protected, 1 means sector protected.
...
typedef struct {
  ...
  uint32_t
      Address; /*!< Flash operation Address offset.
...
#define OB_USER_ALL                                                                                \
  (OB_USER_BOR_LEV | OB_USER_BORH_EN | OB_USER_IWDG_SW | OB_USER_WWDG_SW | OB_USER_NRST_STOP |     \
   OB_USER_NRST_STDBY | OB_USER_IO_VDD_HSLV | OB_USER_IO_VDDIO2_HSLV | OB_USER_IWDG_STOP |         \
   OB_USER_IWDG_STDBY | OB_USER_BOOT_UBE | OB_USER_SWAP_BANK | OB_USER_SRAM1_3_RST |               \
   OB_USER_SRAM2_RST | OB_USER_BKPRAM_ECC | OB_USER_SRAM3_ECC | OB_USER_SRAM2_ECC |                \
   OB_USER_USBPD_DIS | OB_USER_TZEN)
#else
#define OB_USER_ALL                                                                                \
  (OB_USER_BOR_LEV | OB_USER_BORH_EN | OB_USER_IWDG_SW | OB_USER_WWDG_SW | OB_USER_NRST_STOP |     \
   OB_USER_NRST_STDBY | OB_USER_IO_VDD_HSLV | OB_USER_IO_VDDIO2_HSLV | OB_USER_IWDG_STOP |         \
   OB_USER_IWDG_STDBY | OB_USER_SWAP_BANK | OB_USER_SRAM1_RST | OB_USER_SRAM2_RST |                \
   OB_USER_BKPRAM_ECC | OB_USER_SRAM3_ECC | OB_USER_SRAM2_ECC | OB_USER_SRAM1_ECC)
