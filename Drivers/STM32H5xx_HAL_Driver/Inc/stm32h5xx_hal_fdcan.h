...
typedef struct {
  ...
  uint32_t
      ErrorStateIndicator; /*!< Specifies the error state indicator.
...
#define FDCAN_TIMESTAMP_PRESC_2                                                                    \
  ((uint32_t) 0x00010000U) /*!< Timestamp counter time unit in equal to CAN bit time multiplied by \
                              2  */
#define FDCAN_TIMESTAMP_PRESC_3                                                                    \
  ((uint32_t) 0x00020000U) /*!< Timestamp counter time unit in equal to CAN bit time multiplied by \
                              3  */
#define FDCAN_TIMESTAMP_PRESC_4                                                                    \
  ((uint32_t) 0x00030000U) /*!< Timestamp counter time unit in equal to CAN bit time multiplied by \
                              4  */
#define FDCAN_TIMESTAMP_PRESC_5                                                                    \
  ((uint32_t) 0x00040000U) /*!< Timestamp counter time unit in equal to CAN bit time multiplied by \
                              5  */
#define FDCAN_TIMESTAMP_PRESC_6                                                                    \
  ((uint32_t) 0x00050000U) /*!< Timestamp counter time unit in equal to CAN bit time multiplied by \
                              6  */
#define FDCAN_TIMESTAMP_PRESC_7                                                                    \
  ((uint32_t) 0x00060000U) /*!< Timestamp counter time unit in equal to CAN bit time multiplied by \
                              7  */
#define FDCAN_TIMESTAMP_PRESC_8                                                                    \
  ((uint32_t) 0x00070000U) /*!< Timestamp counter time unit in equal to CAN bit time multiplied by \
                              8  */
#define FDCAN_TIMESTAMP_PRESC_9                                                                    \
  ((uint32_t) 0x00080000U) /*!< Timestamp counter time unit in equal to CAN bit time multiplied by \
                              9  */
#define FDCAN_TIMESTAMP_PRESC_10                                                                   \
  ((uint32_t) 0x00090000U) /*!< Timestamp counter time unit in equal to CAN bit time multiplied by \
                              10 */
#define FDCAN_TIMESTAMP_PRESC_11                                                                   \
  ((uint32_t) 0x000A0000U) /*!< Timestamp counter time unit in equal to CAN bit time multiplied by \
                              11 */
#define FDCAN_TIMESTAMP_PRESC_12                                                                   \
  ((uint32_t) 0x000B0000U) /*!< Timestamp counter time unit in equal to CAN bit time multiplied by \
                              12 */
#define FDCAN_TIMESTAMP_PRESC_13                                                                   \
  ((uint32_t) 0x000C0000U) /*!< Timestamp counter time unit in equal to CAN bit time multiplied by \
                              13 */
#define FDCAN_TIMESTAMP_PRESC_14                                                                   \
  ((uint32_t) 0x000D0000U) /*!< Timestamp counter time unit in equal to CAN bit time multiplied by \
                              14 */
#define FDCAN_TIMESTAMP_PRESC_15                                                                   \
  ((uint32_t) 0x000E0000U) /*!< Timestamp counter time unit in equal to CAN bit time multiplied by \
                              15 */
#define FDCAN_TIMESTAMP_PRESC_16                                                                   \
  ((uint32_t) 0x000F0000U) /*!< Timestamp counter time unit in equal to CAN bit time multiplied by \
                              16 */
/**
 * @}
 */
...
#define FDCAN_IT_LIST_PROTOCOL_ERROR                                                               \
  (FDCAN_IT_RESERVED_ADDRESS_ACCESS | FDCAN_IT_DATA_PROTOCOL_ERROR | FDCAN_IT_ARB_PROTOCOL_ERROR | \
   FDCAN_IT_RAM_WATCHDOG | FDCAN_IT_BUS_OFF |                                                      \
...
#define IS_FDCAN_DLC(DLC)                                                                          \
  (((DLC) == FDCAN_DLC_BYTES_0) || ((DLC) == FDCAN_DLC_BYTES_1) || ((DLC) == FDCAN_DLC_BYTES_2) || \
   ...
   ((DLC) == FDCAN_DLC_BYTES_12) || ((DLC) == FDCAN_DLC_BYTES_16) ||                               \
   ((DLC) == FDCAN_DLC_BYTES_20) || ((DLC) == FDCAN_DLC_BYTES_24) ||                               \
   ((DLC) == FDCAN_DLC_BYTES_32) || ((DLC) == FDCAN_DLC_BYTES_48) ||                               \
