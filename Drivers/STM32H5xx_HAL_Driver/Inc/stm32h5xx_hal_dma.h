...
typedef struct {
  ...
  uint32_t BlkHWRequest; /*!< Specifies the Block hardware request mode for DMA channel.
                            ...
                            peripherals. This parameter can be a value of @ref DMA_Block_Request */
  ...
  uint32_t SrcBurstLength; /*!< Specifies the source burst length (number of beats within a burst)
                              for the DMA channel. This parameter can be a value between 1 and 64 */

  uint32_t
      DestBurstLength; /*!< Specifies the destination burst length (number of beats within a burst)
                          for the DMA channel. This parameter can be a value between 1 and 64 */
...
#define GET_DMA_CHANNEL(__HANDLE__)                                                                \
  ((((uint32_t) ((__HANDLE__)->Instance) & HAL_DMA_OFFSET_MASK) - HAL_DMA_CHANNEL_START) /         \
