                                   ...
                                   DMA_NodeTypeDef const *const pNode)
{
  ...
  pNodeConfig->Init.SrcBurstLength =
      ((pNode->LinkRegisters[NODE_CTR1_DEFAULT_OFFSET] & DMA_CTR1_SBL_1) >> DMA_CTR1_SBL_1_Pos) +
      1U;
  pNodeConfig->Init.DestBurstLength =
      ((pNode->LinkRegisters[NODE_CTR1_DEFAULT_OFFSET] & DMA_CTR1_DBL_1) >> DMA_CTR1_DBL_1_Pos) +
      1U;
                                          ...
                                          uint32_t RegisterNumber)
{
  ...
  uint32_t update_link[NODE_MAXIMUM_SIZE] = {DMA_CLLR_UT1, DMA_CLLR_UT2, DMA_CLLR_UB1,
