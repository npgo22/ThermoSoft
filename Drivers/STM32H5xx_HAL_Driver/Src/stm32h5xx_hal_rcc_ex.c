...
void HAL_RCCEx_GetPeriphCLKConfig(RCC_PeriphCLKInitTypeDef *pPeriphClkInit)
{
  ...
  pPeriphClkInit->PeriphClockSelection =
      ...
      RCC_PERIPHCLK_I2C1 | RCC_PERIPHCLK_I2C2 | RCC_PERIPHCLK_LPTIM1 | RCC_PERIPHCLK_LPTIM2 |
      RCC_PERIPHCLK_ADCDAC | RCC_PERIPHCLK_DAC_LP | RCC_PERIPHCLK_RTC | RCC_PERIPHCLK_RNG |
      RCC_PERIPHCLK_I3C1 | RCC_PERIPHCLK_SPI1 | RCC_PERIPHCLK_SPI2 | RCC_PERIPHCLK_SPI3 |
      RCC_PERIPHCLK_CKPER;
      ...
      if (__HAL_RCC_GET_PLL1_CLKOUT_CONFIG(RCC_PLL1_DIVP) != 0U) {
        pPLL1_Clocks->PLL1_P_Frequency =
            (uint32_t) (float_t) (pll1vco /
                                  ((float_t) (uint32_t) ((RCC->PLL1DIVR & RCC_PLL1DIVR_PLL1P) >>
    ...
    if (HAL_IS_BIT_SET(RCC->CR, RCC_CR_PLL1RDY)) {
      if (__HAL_RCC_GET_PLL1_CLKOUT_CONFIG(RCC_PLL1_DIVQ) != 0U) {
        pPLL1_Clocks->PLL1_Q_Frequency =
            (uint32_t) (float_t) (pll1vco /
                                  ((float_t) (uint32_t) ((RCC->PLL1DIVR & RCC_PLL1DIVR_PLL1Q) >>
    ...
    if (HAL_IS_BIT_SET(RCC->CR, RCC_CR_PLL1RDY)) {
      if (__HAL_RCC_GET_PLL1_CLKOUT_CONFIG(RCC_PLL1_DIVR) != 0U) {
        pPLL1_Clocks->PLL1_R_Frequency =
            (uint32_t) (float_t) (pll1vco /
                                  ((float_t) (uint32_t) ((RCC->PLL1DIVR & RCC_PLL1DIVR_PLL1R) >>
      ...
      if (__HAL_RCC_GET_PLL2_CLKOUT_CONFIG(RCC_PLL2_DIVP) != 0U) {
        pPLL2_Clocks->PLL2_P_Frequency =
            (uint32_t) (float_t) (pll2vco /
                                  ((float_t) (uint32_t) ((RCC->PLL2DIVR & RCC_PLL2DIVR_PLL2P) >>
    ...
    if (HAL_IS_BIT_SET(RCC->CR, RCC_CR_PLL2RDY)) {
      if (__HAL_RCC_GET_PLL2_CLKOUT_CONFIG(RCC_PLL2_DIVR) != 0U) {
        pPLL2_Clocks->PLL2_R_Frequency =
            (uint32_t) (float_t) (pll2vco /
                                  ((float_t) (uint32_t) ((RCC->PLL2DIVR & RCC_PLL2DIVR_PLL2R) >>
      ...
      if (__HAL_RCC_GET_PLL3_CLKOUT_CONFIG(RCC_PLL3_DIVP) != 0U) {
        pPLL3_Clocks->PLL3_P_Frequency =
            (uint32_t) (float_t) (pll3vco /
                                  ((float_t) (uint32_t) ((RCC->PLL3DIVR & RCC_PLL3DIVR_PLL3P) >>
    ...
    if (HAL_IS_BIT_SET(RCC->CR, RCC_CR_PLL3RDY)) {
      if (__HAL_RCC_GET_PLL3_CLKOUT_CONFIG(RCC_PLL3_DIVQ) != 0U) {
        pPLL3_Clocks->PLL3_Q_Frequency =
            (uint32_t) (float_t) (pll3vco /
                                  ((float_t) (uint32_t) ((RCC->PLL3DIVR & RCC_PLL3DIVR_PLL3Q) >>
    ...
    if (HAL_IS_BIT_SET(RCC->CR, RCC_CR_PLL3RDY)) {
      if (__HAL_RCC_GET_PLL3_CLKOUT_CONFIG(RCC_PLL3_DIVR) != 0U) {
        pPLL3_Clocks->PLL3_R_Frequency =
            (uint32_t) (float_t) (pll3vco /
                                  ((float_t) (uint32_t) ((RCC->PLL3DIVR & RCC_PLL3DIVR_PLL3R) >>
  ...
  if (PeriphClk == RCC_PERIPHCLK_RTC) {
    ...
    /* Check if HSE is ready and if RTC clock selection is HSE_DIVx*/
      ...
      if (__HAL_RCC_GET_RTC_HSE_PRESCALER() >= RCC_RTC_HSE_DIV2) {
        frequency =
            (HSE_VALUE / ((uint32_t) (__HAL_RCC_GET_RTC_HSE_PRESCALER() >> RCC_CFGR1_RTCPRE_Pos)));
      } else {
        frequency = 0U;
      }
...
HAL_StatusTypeDef HAL_RCCEx_EnablePLL3(RCC_PLL3InitTypeDef *pPLL3Init)
{
  ...
  if (status == HAL_OK) {
    ...
    if (status == HAL_OK) {
      ...
      __HAL_RCC_PLL3_CONFIG(pPLL3Init->PLL3Source, pPLL3Init->PLL3M, pPLL3Init->PLL3N,
                            pPLL3Init->PLL3P, pPLL3Init->PLL3Q, pPLL3Init->PLL3R);
...
static HAL_StatusTypeDef RCCEx_PLL2_Config(const RCC_PLL2InitTypeDef *pll2)
{
  ...
  __HAL_RCC_PLL2_CONFIG(pll2->PLL2Source, pll2->PLL2M, pll2->PLL2N, pll2->PLL2P, pll2->PLL2Q,
                        pll2->PLL2R);
...
static HAL_StatusTypeDef RCCEx_PLL3_Config(const RCC_PLL3InitTypeDef *pll3)
{
  ...
  __HAL_RCC_PLL3_CONFIG(pll3->PLL3Source, pll3->PLL3M, pll3->PLL3N, pll3->PLL3P, pll3->PLL3Q,
                        pll3->PLL3R);
