...
#define SRAMCAN_RF0SA                                                                              \
  ((uint32_t) (SRAMCAN_FLESA + (SRAMCAN_FLE_NBR * SRAMCAN_FLE_SIZE))) /* Rx FIFO 0 Start Address   \
                                                                       */
#define SRAMCAN_RF1SA                                                                              \
  ((uint32_t) (SRAMCAN_RF0SA + (SRAMCAN_RF0_NBR * SRAMCAN_RF0_SIZE))) /* Rx FIFO 1 Start Address   \
                                                                       */
                                   ...
                                   uint32_t BufferIndex)
{
  ...
  TxElementW2 = ((pTxHeader->MessageMarker << 24U) | pTxHeader->TxEventFifoControl |
